...
- Reduces local-listener status overhead by taking one `lsof` snapshot per refresh, polling active Local/SOCKS tunnels every two seconds and fully stopped configurations every 30 seconds, while retaining immediate event and manual refreshes.
